...
const MARKETING_COPY = {
  ...
  pl: {
    ...
    footer: "TidGo pomaga porzadkowac rekordy. To nie jest ksiegowosc, porada podatkowa ani payroll.", companyFooter: "TidGo Ltd. Company number 17356146. 128 City Road, London, EC1V 2NX. hello@tidgo.co.uk", home: "Start", appDemo: "Demo app", accountantDemo: "Demo ksiegowego", deleteAccountLink: "Usun konto", backHome: "Wroc na strone glowna", step: "Krok", foundingTester: "Zostan Founding Tester", testerCalloutTitle: "Chcesz pomóc dopracować TidGo?", testerCalloutText: "Dołącz do zamkniętych testów Androida, używaj aplikacji przez co najmniej 14 dni i wyślij szczery feedback. Nie wymagamy pozytywnej opinii.", testerCalloutButton: "Zostań testerem Androida",
...
Object.assign(MARKETING_COPY.pl, {
  heroTitle: "Jesli umiesz uzywac WhatsAppa, umiesz uzywac TidGo.",
  heroText: "Wyslij zdjecie paragonu, przekaz CIS payslip albo wpisz szybka kwote przychodu. TidGo trzyma rekordy w porzadku, pokazuje co trzeba sprawdzic i szykuje czysta paczke dla ksiegowego.",
  stepSnap: "Wyslij po swojemu",
  stepTidy: "Sprawdz co wymaga uwagi",
  stepPack: "Przekaz porzadne rekordy",
  trustSimple: "Bez konta firmowego w banku.",
  trustControl: "Bez podlaczania banku.",
  trustEarly: "Bez nauki programu ksiegowego.",
  ...
  whatsNewMtd: "TidGo pomaga trzymac cyfrowe rekordy gotowe do kwartalnego workflow MTD u ksiegowego. TidGo jeszcze nie wysyla danych do HMRC.",
  whatsNewCta: "Zobacz wiecej po zalogowaniu.",
  cisTitle: "Takze pod dokumenty CIS",
  cisText: "Przekazuj payslipy, remittance notes i dowody przychodu. W razie potrzeby wpisz kwote recznie, trzymaj dokument podpiety i daj ksiegowemu porzadne rekordy po angielsku.",
  ...
  selfText: "Wysylaj zdjecia paragonow, zapisuj przychod i podpinaj dokumenty CIS, kiedy je masz. TidGo trzyma wszystko w porzadku dla ksiegowego: miesiecznie albo kwartalnie.",
  accountantText: "Zobacz rekordy klienta za jego zgoda, sprawdz co wymaga uwagi i pobierz czytelny angielski CSV/PDF pack bez gonienia za reklamowkami paragonow przed terminem.",
  howTitle: "Ty ogarniasz WhatsAppa. Ksiegowy ogarnia MTD.",
  howText: "Wysylaj paragony i informacje o przychodzie tak, jak juz wysylasz wiadomosci. TidGo uklada wszystko w czytelne angielskie rekordy do kwartalnego sprawdzenia przez ksiegowego.",
  ...
  mtdTestingText: "TidGo pomaga trzymac cyfrowe rekordy i kwartalne podsumowania dla workflow MTD u ksiegowego. Jeszcze nie wysyla deklaracji do HMRC.",
  ...
  launchPricingFullText: "TidGo jest w early access dla malej grupy prawdziwych uzytkownikow. Jest darmowe, kiedy zbieramy feedback, poprawiamy aplikacje i przygotowujemy jasniejsze poradniki. Uzytkownicy dostana jasna informacje z wyprzedzeniem i zawsze beda mogli wyeksportowac albo usunac swoje rekordy.",
