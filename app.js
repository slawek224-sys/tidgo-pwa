...
const MARKETING_COPY = {
  en: {
    ...
    trustEarly: "14 days free, then £5.99/month.",
  ...
  pl: {
    ...
    trustEarly: "14 dni za darmo, potem £5.99 miesięcznie.",
...
MARKETING_COPY.ro = { ...MARKETING_COPY.en,
  ...
  trustEarly: "14 zile gratuit, apoi £5.99 pe luna.",
...
MARKETING_COPY.lt = { ...MARKETING_COPY.en,
  ...
  trustEarly: "14 dienu nemokamai, tada £5.99 per menesi.",
...
Object.assign(MARKETING_COPY.en, {
  ...
  mtd30000: "MTD from April 2027: the £30,000 threshold",
  mtd30000Text: "Qualifying income over £30,000 in 2025/26? See who joins MTD from 6 April 2027 and what to prepare now.",
...
Object.assign(MARKETING_COPY.pl, {
  ...
  mtd30000: "MTD od kwietnia 2027: próg £30 000",
  mtd30000Text: "Qualifying income powyżej £30 000 w 2025/26? Sprawdź, kogo obejmie MTD od 6 kwietnia 2027 i co przygotować.",
...
Object.assign(MARKETING_COPY.ro, {
  ...
  mtd30000: "MTD din aprilie 2027: pragul de £30.000",
  mtd30000Text: "Qualifying income peste £30.000 în 2025/26? Vezi cine intră în MTD din 6 aprilie 2027 și ce trebuie pregătit.",
...
Object.assign(MARKETING_COPY.lt, {
  ...
  mtd30000: "MTD nuo 2027 m. balandžio: £30 000 riba",
  mtd30000Text: "Qualifying income virš £30 000 2025/26 m.? Sužinok, kam MTD taikomas nuo 2027 m. balandžio 6 d. ir ką paruošti.",
...
const EARLY_ACCESS_BANNER_COPY = {
  en: {
    title: "14 days free, then one simple price",
    text: "Start TidGo with a 14-day free trial. After that, the all-inclusive plan is £5.99 per month.",
    button: "Start 14 days free"
  },
  pl: {
    title: "14 dni za darmo, potem jedna prosta cena",
    text: "Zacznij TidGo od 14 dni próbnych. Potem plan all inclusive kosztuje £5.99 miesięcznie.",
    button: "Zacznij 14 dni za darmo"
  },
  ro: {
    title: "14 zile gratuit, apoi un pret simplu",
    text: "Incepe TidGo cu 14 zile gratuite. Apoi planul all-inclusive costa £5.99 pe luna.",
    button: "Incepe 14 zile gratuit"
  },
  lt: {
    title: "14 dienu nemokamai, tada viena aiski kaina",
    text: "Pradek TidGo su 14 nemokamu dienu. Po to all-inclusive planas kainuoja £5.99 per menesi.",
    button: "Pradek 14 dienu nemokamai"
  }
};
...
const PRICING_PAGE_COPY = {
  en: {
    title: "TidGo pricing",
    lead: "14 days free, then one all-inclusive monthly plan.",
    price: "£5.99 per month",
    intro: "Cancel any time. No contracts. No annual commitment. Records stay available for 30 days after cancellation so you can export them.",
  ...
  pl: {
    title: "Cennik TidGo",
    lead: "14 dni za darmo, potem jeden miesięczny plan all inclusive.",
    price: "£5.99 miesięcznie",
    intro: "Anuluj kiedy chcesz. Bez umów i bez rocznego zobowiązania. Po anulowaniu rekordy zostają dostępne przez 30 dni do eksportu.",
    ...
    comingTitle: "Kwartalne raporty MTD - w przygotowaniu",
    comingText: "Pracujemy nad wysyłaniem kwartalnych raportów MTD i czekamy na zatwierdzenie dostępu produkcyjnego przez HMRC. Kolejna informacja od HMRC jest spodziewana do końca września 2026.",
    comingScope: "Raporty kwartalne zawierają narastające sumy przychodów i wydatków - cztery razy w roku. Roczne rozliczenie pozostaje zadaniem Twojego księgowego. Nie zastępujemy go.",
  ...
  ro: {
    title: "Preturi TidGo",
    lead: "14 zile gratuit, apoi un singur plan lunar all-inclusive.",
    price: "£5.99 pe luna",
    ...
    comingTitle: "Rapoarte trimestriale MTD - în dezvoltare",
    comingText: "Lucrăm la trimiterea rapoartelor trimestriale MTD și așteptăm aprobarea HMRC pentru accesul în producție. Următoarea informare HMRC este așteptată până la sfârșitul lunii septembrie 2026.",
    comingScope: "Rapoartele trimestriale conțin totalurile cumulative ale veniturilor și cheltuielilor - de patru ori pe an. Declarația anuală rămâne în grija contabilului tău. Nu îl înlocuim.",
  ...
  lt: {
    title: "TidGo kainos",
    lead: "14 dienu nemokamai, tada vienas menesinis all-inclusive planas.",
    price: "£5.99 per menesi",
    ...
    comingTitle: "Ketvirtinės MTD ataskaitos - kuriama",
    comingText: "Kuriame ketvirtinių MTD ataskaitų teikimo funkciją ir laukiame HMRC leidimo naudoti ją realioje aplinkoje. Kitos HMRC informacijos tikimasi iki 2026 m. rugsėjo pabaigos.",
    comingScope: "Ketvirtinėse ataskaitose pateikiamos kaupiamosios pajamų ir išlaidų sumos - keturis kartus per metus. Metinė deklaracija lieka tavo buhalterio užduotis. Mes jo nepakeičiame.",
...
function marketingPageSlug() {
  ...
  "/musu-istorija": "story",
    ...
    "/mtd/mtd-30000-threshold": "mtd30000",
...
function androidTesterCallout() { return ""; }
...
function mtdTopics() {
  return [
    ...
    ["mtd30000", "mtd30000Text", state.marketingLanguage === "en" ? "/mtd/mtd-30000-threshold" : `/${state.marketingLanguage}/mtd/mtd-30000-threshold`],
...
const MTD_30000_ARTICLES = {
  "en": {
    "title": "MTD from April 2027: does the £30,000 threshold apply to you?",
    "html": "<h2>The short version</h2>\n<p>If you are self-employed or a landlord and your <strong>qualifying income for the 2025/26 tax year is over £30,000</strong>, you will normally need to use Making Tax Digital for Income Tax from <strong>6 April 2027</strong>.</p>\n<p>That means keeping digital records and sending quarterly updates. It does not mean four tax returns or paying Income Tax four times a year.</p>\n<h2>Who exactly does this affect?</h2>\n<p>The £30,000 threshold is based on <strong>qualifying income, not profit</strong>. Qualifying income is your gross income from self-employment and property before expenses, CIS deductions or anything else is taken off.</p>\n<ul>\n<li>Electrician with £35,000 turnover and £18,000 left after expenses: <strong>in</strong>. Turnover counts, not profit.</li>\n<li>Landlord with £8,000 rent plus £24,000 from self-employment: <strong>in</strong>. The two qualifying income sources are added together.</li>\n<li>PAYE employment plus £15,000 freelance income: <strong>out for now</strong>, assuming there is no other qualifying income. PAYE salary does not count and £15,000 is below both the £30,000 threshold for 2027 and the planned £20,000 threshold for 2028.</li>\n</ul>\n<p>Check the details in our <a href=\"/mtd/qualifying-income/\">qualifying income guide</a> or use the official <a href=\"https://www.gov.uk/guidance/work-out-your-qualifying-income-for-making-tax-digital-for-income-tax\" target=\"_blank\" rel=\"noopener\">GOV.UK guidance</a>.</p>\n<h2>Why HMRC is talking about April 2027 now</h2>\n<p>The first MTD group entered in April 2026 at the £50,000 threshold. The April 2027 group is broader: smaller sole traders, landlords and people combining self-employment or property income with a PAYE job.</p>\n<p>HMRC has announced communications for this group, including a “6 months to go” campaign in October 2026. April 2027 is approaching, so this is a useful time to understand the rules without a deadline breathing down your neck.</p>\n<h2>Starting early helps, but do not confuse preparation with a legal backlog</h2>\n<p>If this group applies to you, your MTD digital-record obligation starts on 6 April 2027. You are not required to recreate the previous six or twelve months as MTD records.</p>\n<p>Starting now is still useful practice. You can test a routine, organise receipts and income proof, and find out what your accountant needs before the first live quarter begins.</p>\n<section class=\"article-inline-cta\" data-article-cta=\"mtd-30000-mid\">\n<strong>Start with one clean record today.</strong>\n<p>Add your first receipt or income record, check the details and build the habit before April 2027.</p>\n<a href=\"/app/\">Organise my first record</a>\n</section>\n<h2>What you need to do and when</h2>\n<p><strong>Now:</strong> Check the qualifying income shown by your 2025/26 tax return. If it is over £30,000, read the HMRC guidance and check whether an exemption applies.</p>\n<p><strong>Before 6 April 2027:</strong> Follow HMRC's instructions, choose compatible software and authorise the software you will use for the formal MTD process. The <a href=\"https://www.gov.uk/guidance/find-software-thats-compatible-with-making-tax-digital-for-income-tax\" target=\"_blank\" rel=\"noopener\">HMRC software finder</a> lists recognised products.</p>\n<p><strong>From 6 April 2027:</strong> Keep digital records of business and property income and expenses. Send quarterly updates for each relevant income source. The first standard deadline is <strong>7 August 2027</strong>.</p>\n<p><strong>After the tax year:</strong> Submit the 2027/28 tax return through compatible software by <strong>31 January 2029</strong>. You can do this yourself or ask an accountant to do it.</p>\n<p>For more detail, see our guides to <a href=\"/mtd/digital-records/\">digital records</a>, <a href=\"/mtd/quarterly-updates/\">quarterly updates</a> and <a href=\"/mtd/government-gateway/\">Government Gateway and MTD</a>.</p>\n<h2>Where TidGo fits</h2>\n<p>TidGo collects receipts, income proof and CIS deduction statements as they arrive, through WhatsApp, email intake or the app. It helps turn everyday paperwork into cleaner records for you and your accountant.</p>\n<p><strong>TidGo does not currently submit quarterly updates or tax returns to HMRC.</strong> Formal submissions must be handled by authorised MTD-compatible software or your accountant. TidGo focuses on making the records behind that process easier to collect, review and export.</p>\n<p>Start organising your digital records now, before the deadline pressure arrives.</p>\n<section class=\"article-related\"><h2>Related TidGo guides</h2><ul>\n<li><a href=\"/mtd/who-needs-mtd/\">Does MTD apply to me?</a></li>\n<li><a href=\"/mtd/qualifying-income/\">Qualifying income</a></li>\n<li><a href=\"/mtd/digital-records/\">Digital records</a></li>\n<li><a href=\"/mtd/quarterly-updates/\">Quarterly updates</a></li>\n<li><a href=\"/mtd/government-gateway/\">Government Gateway and MTD</a></li>\n</ul></section>\n<div class=\"article-sources\"><h2>Sources</h2><ul>\n<li><a href=\"https://www.gov.uk/guidance/find-out-if-and-when-you-need-to-use-making-tax-digital-for-income-tax\" target=\"_blank\" rel=\"noopener\">Find out if and when you need to use Making Tax Digital for Income Tax</a></li>\n<li><a href=\"https://www.gov.uk/guidance/work-out-your-qualifying-income-for-making-tax-digital-for-income-tax\" target=\"_blank\" rel=\"noopener\">Work out your qualifying income</a></li>\n<li><a href=\"https://www.gov.uk/guidance/use-making-tax-digital-for-income-tax/send-quarterly-updates\" target=\"_blank\" rel=\"noopener\">Send quarterly updates</a></li>\n<li><a href=\"https://www.gov.uk/government/publications/edition-6-making-tax-digital-for-income-tax-software-developer-newsletter/edition-6-making-tax-digital-for-income-tax-software-developer-newsletter\" target=\"_blank\" rel=\"noopener\">HMRC Software Developer Newsletter: Edition 6</a></li>\n</ul><p><em>Last checked: September 2026. Check GOV.UK again if you are reading this later.</em></p></div>\n<section class=\"article-inline-cta\" data-article-cta=\"mtd-30000-bottom\">\n<strong>April 2027 is getting closer. Your paperwork can get tidier now.</strong>\n<p>Start TidGo with a 14-day free trial. No card is needed to begin.</p>\n<a href=\"/app/\">Start organising my records</a>\n</section>"
  },
  "pl": {
    "title": "MTD od kwietnia 2027: czy próg £30 000 Cię dotyczy?",
    "html": "<h2>Krótko</h2>\n<p>Jeśli jesteś samozatrudniony albo masz przychód z wynajmu, a Twoje <strong>qualifying income za rok podatkowy 2025/26 przekracza £30 000</strong>, od <strong>6 kwietnia 2027</strong> co do zasady obejmie Cię Making Tax Digital for Income Tax.</p>\n<p>Oznacza to cyfrowe rekordy i kwartalne podsumowania. Nie oznacza czterech zeznań podatkowych ani płacenia Income Tax cztery razy w roku.</p>\n<h2>Kogo dokładnie to łapie?</h2>\n<p>Próg £30 000 dotyczy <strong>qualifying income, a nie zysku</strong>. To przychód brutto z samozatrudnienia i wynajmu przed odjęciem kosztów, potrąceń CIS i czegokolwiek innego.</p>\n<ul>\n<li>Elektryk z obrotem £35 000 i £18 000 po kosztach: <strong>w systemie</strong>. Liczy się obrót, nie zysk.</li>\n<li>Landlord z £8 000 czynszu i £24 000 z działalności: <strong>w systemie</strong>. Oba źródła qualifying income sumują się.</li>\n<li>Etat PAYE plus £15 000 z pracy freelance: <strong>na razie poza</strong>, jeśli nie ma innych źródeł qualifying income. Pensja PAYE nie jest liczona, a £15 000 pozostaje poniżej progu £30 000 na 2027 i planowanego progu £20 000 na 2028.</li>\n</ul>\n<p>Szczegóły znajdziesz w naszym poradniku o <a href=\"/pl/mtd/qualifying-income/\">qualifying income</a> i w oficjalnych <a href=\"https://www.gov.uk/guidance/work-out-your-qualifying-income-for-making-tax-digital-for-income-tax\" target=\"_blank\" rel=\"noopener\">wytycznych GOV.UK</a>.</p>\n<h2>Dlaczego HMRC już mówi o kwietniu 2027?</h2>\n<p>Pierwsza grupa weszła do MTD w kwietniu 2026 przy progu £50 000. Grupa na kwiecień 2027 jest szersza: mniejsi sole traderzy, landlordzi oraz osoby łączące działalność albo wynajem z etatem PAYE.</p>\n<p>HMRC zapowiedziało komunikację dla tej grupy, w tym październikową kampanię „6 months to go”. Kwiecień 2027 się zbliża, więc warto zrozumieć zasady, zanim termin zacznie oddychać Ci na kark.</p>\n<h2>Wcześniejszy start pomaga, ale nie tworzy zaległego obowiązku</h2>\n<p>Dla tej grupy obowiązek cyfrowych rekordów MTD zaczyna się 6 kwietnia 2027. Nie musisz odtwarzać wcześniejszych sześciu czy dwunastu miesięcy jako rekordów MTD.</p>\n<p>Możesz jednak wcześniej przećwiczyć prostą rutynę, uporządkować paragony i dowody przychodu oraz ustalić z księgowym, jakich informacji potrzebuje.</p>\n<section class=\"article-inline-cta\" data-article-cta=\"mtd-30000-mid\">\n<strong>Zacznij dziś od jednego porządnego rekordu.</strong>\n<p>Dodaj pierwszy paragon albo przychód, sprawdź szczegóły i wyrób nawyk przed kwietniem 2027.</p>\n<a href=\"/app/\">Uporządkuj pierwszy rekord</a>\n</section>\n<h2>Co zrobić i kiedy</h2>\n<p><strong>Teraz:</strong> Sprawdź qualifying income wykazane w zeznaniu za 2025/26. Jeśli przekracza £30 000, przeczytaj aktualne wytyczne HMRC i sprawdź, czy dotyczy Cię zwolnienie.</p>\n<p><strong>Przed 6 kwietnia 2027:</strong> Postępuj według instrukcji HMRC, wybierz kompatybilne oprogramowanie i autoryzuj software używany do formalnego procesu MTD. <a href=\"https://www.gov.uk/guidance/find-software-thats-compatible-with-making-tax-digital-for-income-tax\" target=\"_blank\" rel=\"noopener\">Wyszukiwarka HMRC</a> pokazuje uznane produkty.</p>\n<p><strong>Od 6 kwietnia 2027:</strong> Prowadź cyfrowe rekordy przychodów i wydatków działalności oraz wynajmu. Wysyłaj quarterly updates dla każdego odpowiedniego źródła. Pierwszy standardowy termin to <strong>7 sierpnia 2027</strong>.</p>\n<p><strong>Po zakończeniu roku:</strong> Złóż tax return za 2027/28 przez kompatybilne oprogramowanie do <strong>31 stycznia 2029</strong>. Możesz zrobić to sam albo zlecić księgowemu.</p>\n<p>Więcej szczegółów znajdziesz w poradnikach o <a href=\"/pl/mtd/digital-records/\">cyfrowych rekordach</a>, <a href=\"/pl/mtd/quarterly-updates/\">quarterly updates</a> i <a href=\"/pl/mtd/government-gateway/\">Government Gateway oraz MTD</a>.</p>\n<h2>Gdzie w tym wszystkim jest TidGo?</h2>\n<p>TidGo zbiera paragony, dowody przychodu i dokumenty potrąceń CIS na bieżąco przez WhatsApp, email intake albo aplikację. Pomaga zamienić codzienny bałagan w czytelniejsze rekordy dla Ciebie i księgowego.</p>\n<p><strong>TidGo obecnie nie wysyła quarterly updates ani tax return do HMRC.</strong> Formalne wysyłki muszą przechodzić przez autoryzowane oprogramowanie kompatybilne z MTD albo przez księgowego. TidGo skupia się na zbieraniu, sprawdzaniu i eksportowaniu rekordów potrzebnych w tym procesie.</p>\n<p>Zacznij porządkować cyfrowe rekordy teraz, zanim pojawi się presja terminu.</p>\n<section class=\"article-related\"><h2>Powiązane poradniki TidGo</h2><ul>\n<li><a href=\"/pl/mtd/who-needs-mtd/\">Czy MTD dotyczy Ciebie?</a></li>\n<li><a href=\"/pl/mtd/qualifying-income/\">Qualifying income</a></li>\n<li><a href=\"/pl/mtd/digital-records/\">Cyfrowe rekordy</a></li>\n<li><a href=\"/pl/mtd/quarterly-updates/\">Quarterly updates</a></li>\n<li><a href=\"/pl/mtd/government-gateway/\">Government Gateway a MTD</a></li>\n</ul></section>\n<div class=\"article-sources\"><h2>Źródła</h2><ul>\n<li><a href=\"https://www.gov.uk/guidance/find-out-if-and-when-you-need-to-use-making-tax-digital-for-income-tax\" target=\"_blank\" rel=\"noopener\">Find out if and when you need to use Making Tax Digital for Income Tax</a></li>\n<li><a href=\"https://www.gov.uk/guidance/work-out-your-qualifying-income-for-making-tax-digital-for-income-tax\" target=\"_blank\" rel=\"noopener\">Work out your qualifying income</a></li>\n<li><a href=\"https://www.gov.uk/guidance/use-making-tax-digital-for-income-tax/send-quarterly-updates\" target=\"_blank\" rel=\"noopener\">Send quarterly updates</a></li>\n<li><a href=\"https://www.gov.uk/government/publications/edition-6-making-tax-digital-for-income-tax-software-developer-newsletter/edition-6-making-tax-digital-for-income-tax-software-developer-newsletter\" target=\"_blank\" rel=\"noopener\">HMRC Software Developer Newsletter: Edition 6</a></li>\n</ul><p><em>Sprawdzone: wrzesień 2026. Jeśli czytasz później, sprawdź ponownie GOV.UK.</em></p></div>\n<section class=\"article-inline-cta\" data-article-cta=\"mtd-30000-bottom\">\n<strong>Kwiecień 2027 jest coraz bliżej. Twoje dokumenty mogą być uporządkowane już teraz.</strong>\n<p>Zacznij TidGo od 14-dniowego bezpłatnego okresu próbnego. Na start nie potrzebujesz karty.</p>\n<a href=\"/app/\">Zacznij porządkować rekordy</a>\n</section>"
  },
  "ro": {
    "title": "MTD din aprilie 2027: ți se aplică pragul de £30.000?",
    "html": "<h2>Pe scurt</h2>\n<p>Dacă lucrezi pe cont propriu sau ai venituri din proprietăți, iar <strong>qualifying income pentru anul fiscal 2025/26 depășește £30.000</strong>, în mod normal va trebui să folosești Making Tax Digital for Income Tax din <strong>6 aprilie 2027</strong>.</p>\n<p>Asta înseamnă evidențe digitale și actualizări trimestriale. Nu înseamnă patru declarații fiscale sau plata impozitului de patru ori pe an.</p>\n<h2>Pe cine afectează exact?</h2>\n<p>Pragul de £30.000 se bazează pe <strong>qualifying income, nu pe profit</strong>. Este venitul brut din activitate independentă și proprietăți, înainte de cheltuieli, deduceri CIS sau orice altă scădere.</p>\n<ul>\n<li>Electrician cu cifră de afaceri de £35.000 și £18.000 rămași după cheltuieli: <strong>intră</strong>. Contează cifra de afaceri, nu profitul.</li>\n<li>Proprietar cu £8.000 chirie și £24.000 din activitate independentă: <strong>intră</strong>. Cele două surse de qualifying income se adună.</li>\n<li>Salariu PAYE plus £15.000 freelance: <strong>deocamdată nu intră</strong>, dacă nu există alte venituri eligibile. Salariul PAYE nu se calculează, iar £15.000 este sub pragul de £30.000 pentru 2027 și sub pragul planificat de £20.000 pentru 2028.</li>\n</ul>\n<p>Vezi ghidul nostru despre <a href=\"/ro/mtd/qualifying-income/\">qualifying income</a> sau <a href=\"https://www.gov.uk/guidance/work-out-your-qualifying-income-for-making-tax-digital-for-income-tax\" target=\"_blank\" rel=\"noopener\">ghidul oficial GOV.UK</a>.</p>\n<h2>De ce vorbește HMRC deja despre aprilie 2027?</h2>\n<p>Primul grup a intrat în aprilie 2026 la pragul de £50.000. Grupul din aprilie 2027 este mai larg: sole traders mai mici, proprietari și persoane care combină activitatea independentă sau venitul din proprietăți cu un job PAYE.</p>\n<p>HMRC a anunțat comunicări pentru acest grup, inclusiv o campanie „6 months to go” în octombrie 2026. Aprilie 2027 se apropie, așa că acum este un moment bun pentru a înțelege regulile fără presiunea termenului.</p>\n<h2>Un început timpuriu ajută, dar nu creează o restanță legală</h2>\n<p>Pentru acest grup, obligația de a păstra evidențe digitale MTD începe la 6 aprilie 2027. Nu trebuie să reconstruiești lunile anterioare ca evidențe MTD.</p>\n<p>Poți însă exersa rutina, organiza bonurile și dovezile de venit și afla ce are nevoie contabilul înainte de primul trimestru real.</p>\n<section class=\"article-inline-cta\" data-article-cta=\"mtd-30000-mid\">\n<strong>Începe astăzi cu o singură înregistrare corectă.</strong>\n<p>Adaugă primul bon sau venit, verifică detaliile și formează obiceiul înainte de aprilie 2027.</p>\n<a href=\"/app/\">Organizează prima înregistrare</a>\n</section>\n<h2>Ce trebuie să faci și când</h2>\n<p><strong>Acum:</strong> Verifică qualifying income din declarația pentru 2025/26. Dacă depășește £30.000, citește instrucțiunile HMRC și verifică dacă ți se aplică o scutire.</p>\n<p><strong>Înainte de 6 aprilie 2027:</strong> Urmează instrucțiunile HMRC, alege software compatibil și autorizează produsul folosit pentru procesul MTD. <a href=\"https://www.gov.uk/guidance/find-software-thats-compatible-with-making-tax-digital-for-income-tax\" target=\"_blank\" rel=\"noopener\">Lista HMRC</a> arată produsele recunoscute.</p>\n<p><strong>Din 6 aprilie 2027:</strong> Păstrează evidențe digitale ale veniturilor și cheltuielilor din activitate și proprietăți. Trimite actualizări trimestriale pentru fiecare sursă relevantă. Primul termen standard este <strong>7 august 2027</strong>.</p>\n<p><strong>După anul fiscal:</strong> Trimite declarația fiscală 2027/28 prin software compatibil până la <strong>31 ianuarie 2029</strong>. O poți face singur sau prin contabil.</p>\n<p>Vezi și ghidurile despre <a href=\"/ro/mtd/digital-records/\">evidențe digitale</a>, <a href=\"/ro/mtd/quarterly-updates/\">actualizări trimestriale</a> și <a href=\"/ro/mtd/government-gateway/\">Government Gateway și MTD</a>.</p>\n<h2>Unde se încadrează TidGo?</h2>\n<p>TidGo colectează bonuri, dovezi de venit și documente de deducere CIS pe măsură ce apar, prin WhatsApp, email intake sau aplicație. Ajută la transformarea actelor zilnice în evidențe mai curate pentru tine și contabil.</p>\n<p><strong>TidGo nu trimite în prezent actualizări trimestriale sau declarații fiscale către HMRC.</strong> Trimiterile oficiale trebuie făcute prin software autorizat compatibil cu MTD sau prin contabil. TidGo se concentrează pe colectarea, verificarea și exportarea evidențelor din spatele procesului.</p>\n<p>Începe să-ți organizezi evidențele digitale acum, înainte să apară presiunea termenului.</p>\n<section class=\"article-related\"><h2>Ghiduri TidGo asociate</h2><ul>\n<li><a href=\"/ro/mtd/who-needs-mtd/\">Ți se aplică MTD?</a></li>\n<li><a href=\"/ro/mtd/qualifying-income/\">Qualifying income</a></li>\n<li><a href=\"/ro/mtd/digital-records/\">Evidențe digitale</a></li>\n<li><a href=\"/ro/mtd/quarterly-updates/\">Actualizări trimestriale</a></li>\n<li><a href=\"/ro/mtd/government-gateway/\">Government Gateway și MTD</a></li>\n</ul></section>\n<div class=\"article-sources\"><h2>Surse</h2><ul>\n<li><a href=\"https://www.gov.uk/guidance/find-out-if-and-when-you-need-to-use-making-tax-digital-for-income-tax\" target=\"_blank\" rel=\"noopener\">Find out if and when you need to use Making Tax Digital for Income Tax</a></li>\n<li><a href=\"https://www.gov.uk/guidance/work-out-your-qualifying-income-for-making-tax-digital-for-income-tax\" target=\"_blank\" rel=\"noopener\">Work out your qualifying income</a></li>\n<li><a href=\"https://www.gov.uk/guidance/use-making-tax-digital-for-income-tax/send-quarterly-updates\" target=\"_blank\" rel=\"noopener\">Send quarterly updates</a></li>\n<li><a href=\"https://www.gov.uk/government/publications/edition-6-making-tax-digital-for-income-tax-software-developer-newsletter/edition-6-making-tax-digital-for-income-tax-software-developer-newsletter\" target=\"_blank\" rel=\"noopener\">HMRC Software Developer Newsletter: Edition 6</a></li>\n</ul><p><em>Verificat: septembrie 2026. Dacă citești mai târziu, verifică din nou GOV.UK.</em></p></div>\n<section class=\"article-inline-cta\" data-article-cta=\"mtd-30000-bottom\">\n<strong>Aprilie 2027 se apropie. Actele tale pot fi ordonate de acum.</strong>\n<p>Începe TidGo cu o perioadă gratuită de 14 zile. Nu ai nevoie de card pentru a începe.</p>\n<a href=\"/app/\">Începe să organizezi evidențele</a>\n</section>"
  },
  "lt": {
    "title": "MTD nuo 2027 m. balandžio: ar tau taikoma £30 000 riba?",
    "html": "<h2>Trumpai</h2>\n<p>Jei dirbi savarankiškai arba gauni pajamų iš nuomos, o tavo <strong>2025/26 mokestinių metų qualifying income viršija £30 000</strong>, paprastai turėsi naudoti Making Tax Digital for Income Tax nuo <strong>2027 m. balandžio 6 d.</strong></p>\n<p>Tai reiškia skaitmeninius įrašus ir ketvirtines ataskaitas. Tai nereiškia keturių mokesčių deklaracijų ar mokesčių mokėjimo keturis kartus per metus.</p>\n<h2>Kam tai tiksliai taikoma?</h2>\n<p>£30 000 riba grindžiama <strong>qualifying income, o ne pelnu</strong>. Tai bendrosios pajamos iš savarankiškos veiklos ir nuomos prieš išlaidas, CIS atskaitymus ar kitus atskaitymus.</p>\n<ul>\n<li>Elektrikas, kurio apyvarta £35 000, o po išlaidų lieka £18 000: <strong>patenka</strong>. Skaičiuojama apyvarta, ne pelnas.</li>\n<li>Nuomotojas, gaunantis £8 000 nuomos ir £24 000 iš savarankiškos veiklos: <strong>patenka</strong>. Abu qualifying income šaltiniai sudedami.</li>\n<li>PAYE darbas ir £15 000 freelance pajamų: <strong>kol kas nepatenka</strong>, jei nėra kitų qualifying income pajamų. PAYE atlyginimas neskaičiuojamas, o £15 000 nesiekia nei £30 000 ribos 2027 m., nei planuojamos £20 000 ribos 2028 m.</li>\n</ul>\n<p>Žr. mūsų <a href=\"/lt/mtd/qualifying-income/\">qualifying income vadovą</a> arba oficialias <a href=\"https://www.gov.uk/guidance/work-out-your-qualifying-income-for-making-tax-digital-for-income-tax\" target=\"_blank\" rel=\"noopener\">GOV.UK gaires</a>.</p>\n<h2>Kodėl HMRC jau kalba apie 2027 m. balandį?</h2>\n<p>Pirmoji grupė pradėjo 2026 m. balandį, kai riba buvo £50 000. 2027 m. balandžio grupė yra platesnė: mažesni sole traders, nuomotojai ir žmonės, derinantys savarankišką veiklą ar nuomą su PAYE darbu.</p>\n<p>HMRC paskelbė šiai grupei skirtą komunikaciją, įskaitant 2026 m. spalio kampaniją „6 months to go“. 2027 m. balandis artėja, todėl dabar tinkamas laikas suprasti taisykles be termino spaudimo.</p>\n<h2>Ankstyvas startas padeda, bet nesukuria ankstesnės teisinės prievolės</h2>\n<p>Šiai grupei MTD skaitmeninių įrašų prievolė prasideda 2027 m. balandžio 6 d. Ankstesnių mėnesių nereikia atkurti kaip MTD įrašų.</p>\n<p>Tačiau gali iš anksto išbandyti rutiną, sutvarkyti kvitus ir pajamų įrodymus bei išsiaiškinti, ko reikės buhalteriui.</p>\n<section class=\"article-inline-cta\" data-article-cta=\"mtd-30000-mid\">\n<strong>Pradėk šiandien nuo vieno tvarkingo įrašo.</strong>\n<p>Pridėk pirmą kvitą arba pajamų įrašą, patikrink informaciją ir suformuok įprotį iki 2027 m. balandžio.</p>\n<a href=\"/app/\">Sutvarkyti pirmą įrašą</a>\n</section>\n<h2>Ką daryti ir kada</h2>\n<p><strong>Dabar:</strong> Patikrink 2025/26 deklaracijoje nurodytas qualifying income pajamas. Jei jos viršija £30 000, perskaityk HMRC gaires ir patikrink, ar tau netaikoma išimtis.</p>\n<p><strong>Iki 2027 m. balandžio 6 d.:</strong> Laikykis HMRC instrukcijų, pasirink suderinamą programinę įrangą ir autorizuok produktą, naudojamą oficialiam MTD procesui. <a href=\"https://www.gov.uk/guidance/find-software-thats-compatible-with-making-tax-digital-for-income-tax\" target=\"_blank\" rel=\"noopener\">HMRC sąraše</a> pateikti pripažinti produktai.</p>\n<p><strong>Nuo 2027 m. balandžio 6 d.:</strong> Tvarkyk skaitmeninius veiklos ir nuomos pajamų bei išlaidų įrašus. Siųsk ketvirtines ataskaitas už kiekvieną atitinkamą pajamų šaltinį. Pirmasis standartinis terminas yra <strong>2027 m. rugpjūčio 7 d.</strong></p>\n<p><strong>Pasibaigus mokestiniams metams:</strong> Pateik 2027/28 mokesčių deklaraciją per suderinamą programinę įrangą iki <strong>2029 m. sausio 31 d.</strong> Tai gali padaryti pats arba buhalteris.</p>\n<p>Taip pat skaityk apie <a href=\"/lt/mtd/digital-records/\">skaitmeninius įrašus</a>, <a href=\"/lt/mtd/quarterly-updates/\">ketvirtines ataskaitas</a> ir <a href=\"/lt/mtd/government-gateway/\">Government Gateway bei MTD</a>.</p>\n<h2>Kur čia TidGo?</h2>\n<p>TidGo renka kvitus, pajamų įrodymus ir CIS atskaitymo dokumentus per WhatsApp, email intake arba programėlę. Tai padeda kasdienius dokumentus paversti tvarkingesniais įrašais tau ir buhalteriui.</p>\n<p><strong>TidGo šiuo metu nesiunčia ketvirtinių ataskaitų ar mokesčių deklaracijų HMRC.</strong> Oficialius pateikimus turi atlikti autorizuota su MTD suderinama programinė įranga arba buhalteris. TidGo padeda rinkti, tikrinti ir eksportuoti šiam procesui reikalingus įrašus.</p>\n<p>Pradėk tvarkyti skaitmeninius įrašus dabar, dar prieš atsirandant termino spaudimui.</p>\n<section class=\"article-related\"><h2>Susiję TidGo vadovai</h2><ul>\n<li><a href=\"/lt/mtd/who-needs-mtd/\">Ar MTD taikomas tau?</a></li>\n<li><a href=\"/lt/mtd/qualifying-income/\">Qualifying income</a></li>\n<li><a href=\"/lt/mtd/digital-records/\">Skaitmeniniai įrašai</a></li>\n<li><a href=\"/lt/mtd/quarterly-updates/\">Ketvirtinės ataskaitos</a></li>\n<li><a href=\"/lt/mtd/government-gateway/\">Government Gateway ir MTD</a></li>\n</ul></section>\n<div class=\"article-sources\"><h2>Šaltiniai</h2><ul>\n<li><a href=\"https://www.gov.uk/guidance/find-out-if-and-when-you-need-to-use-making-tax-digital-for-income-tax\" target=\"_blank\" rel=\"noopener\">Find out if and when you need to use Making Tax Digital for Income Tax</a></li>\n<li><a href=\"https://www.gov.uk/guidance/work-out-your-qualifying-income-for-making-tax-digital-for-income-tax\" target=\"_blank\" rel=\"noopener\">Work out your qualifying income</a></li>\n<li><a href=\"https://www.gov.uk/guidance/use-making-tax-digital-for-income-tax/send-quarterly-updates\" target=\"_blank\" rel=\"noopener\">Send quarterly updates</a></li>\n<li><a href=\"https://www.gov.uk/government/publications/edition-6-making-tax-digital-for-income-tax-software-developer-newsletter/edition-6-making-tax-digital-for-income-tax-software-developer-newsletter\" target=\"_blank\" rel=\"noopener\">HMRC Software Developer Newsletter: Edition 6</a></li>\n</ul><p><em>Patikrinta: 2026 m. rugsėjis. Jei skaitai vėliau, dar kartą patikrink GOV.UK.</em></p></div>\n<section class=\"article-inline-cta\" data-article-cta=\"mtd-30000-bottom\">\n<strong>2027 m. balandis artėja. Dokumentus gali sutvarkyti jau dabar.</strong>\n<p>Pradėk naudoti TidGo su 14 dienų nemokamu bandomuoju laikotarpiu. Kortelės pradžiai nereikia.</p>\n<a href=\"/app/\">Pradėti tvarkyti įrašus</a>\n</section>"
  }
};

function mtd30000Article() {
  const article = MTD_30000_ARTICLES[state.marketingLanguage] || MTD_30000_ARTICLES.en;
  return `
    <article class="marketing-page-card marketing-article">
      <span class="eyebrow">${mk("navMtd")}</span>
      <h1>${article.title}</h1>
...
function mtdKnowledgeHref(slug) {
  const localized = ["what-you-do-accountant-does", "automatically-signed-up", "mtd-30000-threshold", "qualifying-income", "government-gateway", "do-i-have-to-photograph-receipts", "digital-records", "cis", "cis-myths", "quarterly-updates"];
...
function marketingPage() {
  ...
  } else if (slug === "mtd30000") {
    body = mtd30000Article();
...
function androidTestersPage() {
  ...
  const c = retired[state.marketingLanguage] || retired.en;
  shell(`<section class="landing-screen marketing-page-screen">${landingHeader("")}<article class="marketing-page-card marketing-article"><h1>${escapeHtml(c[0])}</h1><p>${escapeHtml(c[1])}</p><a class="primary landing-link" href="/app">${escapeHtml(c[2])}</a></article>${landingFooter()}</section>`);
}
