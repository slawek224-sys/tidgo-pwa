...
const MARKETING_COPY = {
  en: {
    ...
    mtdTitle: "MTD records without the accounting chaos", mtdText: "Making Tax Digital starts with keeping records digital. TidGo does not replace your accountant and does not submit your tax returns. It helps you keep receipts, income proof and summaries in one tidy place.", faqTitle: "FAQ:", faqText: "More answers are coming soon. For now, try the app, open the accountant portal, or send a message below.",
  ...
  pl: {
    ...
    mtdTitle: "Rekordy MTD bez chaosu ksiegowego", mtdText: "Making Tax Digital zaczyna sie od trzymania rekordow cyfrowo. TidGo nie zastepuje ksiegowego i nie wysyla Twoich deklaracji podatkowych. Pomaga trzymac paragony, dowody przychodu i podsumowania w jednym uporzadkowanym miejscu.", faqTitle: "FAQ:", faqText: "Wiecej odpowiedzi wkrotce. Na razie zobacz aplikacje, portal ksiegowego albo wyslij wiadomosc ponizej.",
...
MARKETING_COPY.ro = { ...MARKETING_COPY.en,
  ...
  mtdTitle: "Evidente MTD fara haos contabil", mtdText: "Making Tax Digital incepe cu pastrarea evidentelor in format digital. TidGo nu inlocuieste contabilul si nu trimite declaratiile tale fiscale. Te ajuta sa pastrezi bonuri, dovezi de venit si rezumate intr-un singur loc ordonat.", faqTitle: "FAQ:", faqText: "Mai multe raspunsuri vin curand. Deocamdata poti incerca aplicatia, portalul contabilului sau trimite un mesaj.",
...
MARKETING_COPY.lt = { ...MARKETING_COPY.en,
  ...
  mtdTitle: "MTD irasai be buhalterinio chaoso", mtdText: "Making Tax Digital prasideda nuo skaitmeniniu irasu. TidGo nepakeicia buhalterio ir neteikia jusu mokesciu deklaraciju. Jis padeda laikyti kvitus, pajamu irodymus ir suvestines vienoje tvarkingoje vietoje.", faqTitle: "DUK:", faqText: "Daugiau atsakymu bus greitai. Kol kas galite isbandyti programa, buhalterio portala arba parasyti zinute.",
