...
(This file follows the [agents.md](https://agents.md) convention read by Codex and other compatible coding agents. It intentionally mirrors `CLAUDE.md` in this repo so Claude Code and Codex work from the same information.)
